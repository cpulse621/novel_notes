...
export type { AspectCSS, AspectKey, ThemeModule, ThemeData, ThemeMeta, ThemeOptions } from "./quartz-themes"
...
export { CALLOUT_ALIASES, CALLOUT_ICON_MAP, CHECKBOX_ICON_MAP, generateCalloutIconCSS, generateCheckboxIconCSS, getAvailableThemes, getThemeMeta, loadTheme, registerTheme, resolveCalloutIcon, resolveCheckboxIcon, resolveThemeId } from "./quartz-themes"
...
export const plugins: Record<string, Record<string, (...args: unknown[]) => void>> = {
  ...
  "quartz-community__hard-line-breaks": {
    HardLineBreaks: (...args: unknown[]) => { componentRegistry.setOptionOverrides("quartz-community__hard-line-breaks", args[0] as Record<string, unknown>); },
  },
  ...
  "quartz-community__footer": {
    Footer: (...args: unknown[]) => { componentRegistry.setOptionOverrides("quartz-community__footer", args[0] as Record<string, unknown>); },
  },
...
export const HardLineBreaks = plugins["quartz-community__hard-line-breaks"].HardLineBreaks
...
export const Footer = plugins["quartz-community__footer"].Footer
